...
from tuesmon_contrib_github_auth import connector as github
...
def test_login_without_settings_params():
    with pytest.raises(github.GitHubApiError) as e, \
            patch("tuesmon_contrib_github_auth.connector.requests") as m_requests:
...
def test_login_success():
    with patch("tuesmon_contrib_github_auth.connector.requests") as m_requests, \
            patch("tuesmon_contrib_github_auth.connector.CLIENT_ID") as CLIENT_ID, \
            patch("tuesmon_contrib_github_auth.connector.CLIENT_SECRET") as CLIENT_SECRET:
        CLIENT_ID = "*CLIENT_ID*"
...
def test_me():
    with patch("tuesmon_contrib_github_auth.connector.login") as m_login, \
            patch("tuesmon_contrib_github_auth.connector.get_user_profile") as m_get_user_profile, \
            patch("tuesmon_contrib_github_auth.connector.get_user_emails") as m_get_user_emails:
